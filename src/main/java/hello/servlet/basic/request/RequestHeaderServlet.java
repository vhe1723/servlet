...
//        Enumeration<String> headerNames = request.getHeaderNames(); //http의 요청 모든 헤더정보 출력
//        while(headerNames.hasMoreElements()){   //다음요소여부 확인
//            String headerName = headerNames.nextElement();
//            System.out.println(headerName + " : " + headerName);
//        }

        request.getHeaderNames().asIterator()       //요즘 방식
